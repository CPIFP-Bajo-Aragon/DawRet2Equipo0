...
<br><br>
    ...
    <div class="card bg-light mt-5 w-75 card-center m-auto" >
        <h2 class="card-header"> Centros</h2>
        <div class="table-responsive">
            <table class="table table-hover">
                <thead>
                    <tr>
                        <th scope="col">Nombre <i id="nombre" onclick="paginar(this)" class="fa-solid fa-arrow-up-wide-short ordenar"></i></th>
                        <th scope="col">Distancia (Kms)</th>
                        <th scope="col">Ciudad <i id="anyo_nacimiento" onclick="paginar(this)" class="fa-solid fa-arrow-up-wide-short ordenar"></i></th>
...
<div id="modal1" class="modal-container">
    ...
    <script type="text/javascript">
        ...
        let arrayPHP = <?php echo json_encode($datos['centros']);?>;
        let arrayJS = arrayPHP.slice();
        let tableName = "Centros";
        console.log(arrayJS);
        ...
        "distancia",
        "nombre_ciudad",
        "idCentro" /* Clave siempre al final */
        ];
        ...
        let funciones = [
            ...
            "centro", /* controlador */
            "borrarcentro", /* función borrar */
            "editarcentro", /* función editar */
            "idCentro", /* idUser */
        ]
