...
<br><br>
                                ...
                                <div class="dropdown">
                                    ...
                                    <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                        ...
                                        <?php
                                            ...
                                            <li><a class="dropdown-item" href="#" id="<?php echo $ciudad -> idCiudad?>" onclick="filtrar(this, 'idCiudad')"><?php echo $ciudad -> nombre?></a></li>
                                        <?php endforeach; ?>
    ...
    <div class="card bg-light mt-5 w-75 card-center m-auto" >
        <h2 class="card-header"> Ciudades</h2>
...
<div id="modal1" class="modal-container">
    ...
    <script type="text/javascript">
        ...
        let arrayPHP = <?php echo json_encode($datos['ciudades']);?>;
        let arrayJS = arrayPHP.slice();
        let tableName = "Ciudades";
        console.log(arrayJS);
        ...
        "nombre",
        "cuantia",
        "idCiudad" /* Clave siempre al final */
        ];
        ...
        let funciones = [
            ...
            "ciudad", /* controlador */
            "borrarciudad", /* función borrar */
            "editarciudad", /* función editar */
            "idCiudad", /* idUser */
        ]
