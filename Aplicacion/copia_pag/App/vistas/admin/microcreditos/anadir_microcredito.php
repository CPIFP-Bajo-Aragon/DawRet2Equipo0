    ...
    <div class="col-10 mx-auto">
        ...
        <form method="post" id="idFormulario">
            <label class="form-label" for="importe">Importe:</label><br>
                <input class="form-control" type="text" id="importe" name="importe" required><br>
            <label class="form-label" for="estado">Estado:</label><br>
                <input class="form-control" type="text" id="estado" name="estado" required><br>
            ...
            <label class="form-label" for="fechaPrestamo">Fecha de prestamo:</label>
                <input class="form-control" type="date" id="fechaPrestamo" name="fechaPrestamo" required><br>
            ...
            <label class="form-label" for="idMovimiento">Movimiento:</label><br>
                <select class="form-control" type="text" id="idMovimiento" name="idMovimiento"><br>
